...
export class Robot {
  ...
  drawOnCanvas() {
    ...
    //   let robotWidth = 20;
    //   let robotHeight = 10;
    //   let x = columnWidth / 2 - robotWidth / 2 + columnWidth * this.position.x;
    //   let y = rowHeight / 2 - robotHeight / 2 + rowHeight * this.position.y;
    //   console.log(numberOfRows);
    //   context.beginPath();
    //   context.rect(
    //     x,
    //     y,
    //     // this.position.x * columnWidth,
    //     // this.position.y * rowHeight,
    //     robotWidth,
    //     robotHeight
    //   );
    //   context.stroke();
